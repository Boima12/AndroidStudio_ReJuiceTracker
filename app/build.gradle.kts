plugins {
    ...
    id("com.google.devtools.ksp") version "1.9.22-1.0.17" // Match with Kotlin version
}

android {
    namespace = "com.example.rejuicetracker"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.rejuicetracker"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    composeOptions {
        kotlinCompilerExtensionVersion = "1.5.9" // Updated to latest stable version
    }
    packaging {
        resources {
